...
public class EditProfileActivity extends AppCompatActivity {
    ...
    EditText editName, editEmail, editPassword, editAmount;
    Button saveButton;
    String nameUser, emailUser, passwordUser, amountUser;
    ...
    private void showData() {
        ...
        amountUser = intent.getStringExtra("amount");
        passwordUser = intent.getStringExtra("password");
        editName.setText(nameUser);
        editEmail.setText(emailUser);
        editAmount.setText(amountUser);
